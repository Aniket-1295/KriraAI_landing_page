...
const pricingPlans = [
  {
    ...
    features: ["AI & ML consulting", "Basic architecture design", "Technical guidance", "Startup-friendly pricing"],
    popular: false,
    cta: "Get Started",
  },
  {
    ...
    monthlyPrice: null,
    price: "Custom",
    description: "For established enterprises at scale",
    features: [
  ...
  },
  {
    name: "Staffing",
    price: "Custom",
    description: "Hire dedicated tech experts",
    features: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
            Choose the engagement model that best fits your business needs. All plans include dedicated support.
          </p>
