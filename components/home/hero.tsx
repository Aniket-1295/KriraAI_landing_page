        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              ...
              >
               Best AI Development <strong>Services For</strong>{" "}
                <br />
                <strong>Innovative IT Solutions</strong>{" "}
                <em className="italic">& Business Success.</em>
              </h1>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <a href="#services">
                  <div className="group cursor-pointer border border-border bg-card/50 gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:bg-card transition-colors">
                    <div className="border border-border bg-background/50 h-[40px] rounded-full flex items-center justify-center">
                      <p className="font-medium tracking-tight mr-3 ml-3 flex items-center gap-2 justify-center text-base text-foreground">
                        Our Expertise
                      </p>
                    </div>
                    <div className="text-muted-foreground group-hover:ml-4 ease-in-out transition-all size-[24px] flex items-center justify-center rounded-full border-2 border-border">
